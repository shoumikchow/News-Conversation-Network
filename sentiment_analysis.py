...
indicoio.config.api_key = '7d435e2216b698d91a0975c8066dedb8'
...
with open("./Scraped data/quotations_and_speeches_v2.0.csv", "r") as file:
    ...
    for row in reader:
        ...
        with open("./Scraped data/quotations_and_speeches_with_sentiment_5_v2.1.csv", "a") as out:
            writer = csv.writer(out)
