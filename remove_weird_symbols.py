import csv
with open("/home/shoumik/Documents/Kolpokoushol/Scraped data/final v1.1.csv", "r") as file:
    ...
    for row in reader:
        ...
        f = csv.writer(open("/home/shoumik/Documents/Kolpokoushol/Scraped data/final v1.2.csv", "a"))
